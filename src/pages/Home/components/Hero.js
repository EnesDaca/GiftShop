  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
        <div className="text my-5">
            <h1 className="text-5xl font-bold">The Perfect Present Emporium</h1>
            ...
            <Link to="/products" type="button" className="text-white tirkiz hover:tirkiz2 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 focus:outline-none dark:focus:ring-blue-800">Explore gifts</Link>
        </div>
